...
{
    public partial class OracleAccessControlProvider : AccessControlProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            _daoTemplate = new DAOTemplate(ConnectionString, new DevartOracleDaoProvider());
        }
        ...
        {
            _userSqlBuilder = new OracleSqlBuilder(_userTable);
        }
    }
