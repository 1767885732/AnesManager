...
namespace Wis.Anes.Layouts
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class TopBarControlEx : XtraUserControl, IOperationStatusObserver
    {
        public TopBarControlEx()
        {
            InitializeComponent();
        ...
        /// 工作区域引用封装
        /// </summary>
        private ShellFrm _MainFormRef = null;
        /// <summary>
        /// 工作区域引用封装
        /// </summary>
        public ShellFrm MainFormRef
        {
       ...
       // private IPatientStatusAction patientStatusAction = null;
        ...
        public void RefreshPatientInfo(string roomNo, string patientID, string name)
        {
            ...
            {
                lblAnesAssistant.Text = ExtendApplicationContext.Current.PatientInformation.AnesAssistant;
                lblAnesDoctor.Text = ExtendApplicationContext.Current.PatientInformation.AnesDoctor;
                string opname = "";
                if (ExtendApplicationContext.Current.PatientInformation.OperationName.Length > 7) {
                    opname = ExtendApplicationContext.Current.PatientInformation.OperationName.Substring(0, 8)+"...";
                }
                else
                {
                    opname = ExtendApplicationContext.Current.PatientInformation.OperationName;
                }
                lblOperationName.Text = opname;
                lblOperationTime.Text = ExtendApplicationContext.Current.PatientInformation.OperationTime.ToString();
                //lblPatInfoLine.Visible = true;
                picPersonIcon.Visible = true;
                lblRoomNo.Visible = true;
                lblPatientID.Visible = true;
                lblName.Visible = true;
                lblAnesAssistant.Visible = true;
                lblAnesDoctor.Visible = true;
                lblOperationName.Visible = true;
                lblOperationTime.Visible = true;
            }
            else
            {
                ...
                lblAnesAssistant.Visible = false;
                lblAnesDoctor.Visible = false;
                lblOperationName.Visible = false;
                lblOperationTime.Visible = false;
            }
        ...
        private void TopBarControl_Resize(object sender, EventArgs e)
        {
            ...
            patientStatusContrl1.Width = this.Width - panel1.Width - panelRight.Width - 5;
            panelRight.Left = patientStatusContrl1.Right - 1;
        ...
        private void patientStatusContrl1_Load(object sender, EventArgs e)
        {
