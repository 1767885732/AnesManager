   ...
   public class AccessControl
    {
       ...
       public static bool AddPermission(string permissionKey, string value)
       {
           ...
           {
               ExtendApplicationContext.Current.PermissionContext.Permissions.Add(permissionKey.ToUpper(), value);
               result = true;
           }
           return result;
       }
       ...
       {
           if (ExtendApplicationContext.Current.LoginUserContext.IsManager) return true;
           bool result = false;

           if (ExtendApplicationContext.Current.PermissionContext.Permissions.ContainsKey(permissionKey.ToUpper()))
           {
               if (ExtendApplicationContext.Current.PermissionContext.Permissions[permissionKey.ToUpper()].ToString().ToUpper().Equals("T"))
               {
                   result = true;
               }
           }
