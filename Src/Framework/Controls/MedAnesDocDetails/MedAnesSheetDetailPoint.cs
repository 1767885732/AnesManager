...
namespace Wis.Anes.Framework.Controls
{
    ...
    public class MedAnesSheetDetailPoint
    {
        ...
        /// <param name="startTime">开始时间</param>
        /// <param name="text">文本（名称）</param>
        public MedAnesSheetDetailPoint(DateTime startTime, string text, DataRow row)
        {
            _startTime = startTime;
            _text = text;
            _datarow = row;
        ...
        /// <param name="text">文本（名称）</param>
        public MedAnesSheetDetailPoint(DateTime startTime, DateTime endTime, string text, DataRow row)
        ...
        public MedAnesSheetDetailPoint(DateTime startTime, string text, double value, string unit, string route, DataRow row)
            : this(startTime, text, row)
        {
            _value = value;
            _unit = unit;
        ...
        /// <param name="unit">单位</param>
        /// <param name="route">途径</param>
        public MedAnesSheetDetailPoint(DateTime startTime, DateTime endTime, string text, double value, string unit, string route, DataRow row)
        ...
        /// <param name="value">值</param>
        /// <param name="unit">单位</param>
        public MedAnesSheetDetailPoint(string text, double value, string unit, DataRow row)
        {
            _text = text;
            _value = value;
            _unit = unit;
