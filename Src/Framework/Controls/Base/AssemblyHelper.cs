      ...
      static   Dictionary<string, Type> _typeCache = new Dictionary<string, Type>();
        ...
        public static object ReadObject(XmlNode node, ArrayList errors, object myinstance)
        {
            ...
            if (myinstance != null)
            {
                ...
                else if (type.Equals(typeof(Wis.Anes.Framework.Designer.ReportViewProperties)))
                {
                    //instance = Activator.CreateInstance(type);
                    instance = new Wis.Anes.Framework.Designer.ReportViewProperties();
                    (myinstance as MedReportView).AddComponent(instance as Wis.Anes.Framework.Designer.ReportViewProperties);
                }
                else
                {
                    instance = myinstance;
