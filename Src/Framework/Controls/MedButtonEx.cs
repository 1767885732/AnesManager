...
namespace Wis.Anes.Framework.Controls
{
    ...
    public partial class MedButtonEx : DevExpress.XtraEditors.SimpleButton
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Rectangle imageRect = new Rectangle(0, 0, this.Width, this.Height);//图像区域
            Rectangle textRect = new Rectangle(0, 0, this.Width, this.Height);//文字区域
            ...
            TextRenderer.DrawText(g, Text, Font, textRect, ForeColor, TextFormatFlags.VerticalCenter | TextFormatFlags.HorizontalCenter);
        }
               ...
               LinearGradientMode mode)
        {
            ...
            using (LinearGradientBrush brush = new LinearGradientBrush(rect, Color.Transparent, Color.Transparent, mode))
            {
                ...
                if (style != RoundStyle.None)
                {
                    ...
                    //    GraphicsPathHelper.CreatePath(rect, roundWidth, style))
                    //{
    ...
    {
        public static GraphicsPath CreatePath(Rectangle rect, int roundWidth, RoundStyle arcRadius)
        {
            ...
            {
                path.AddArc(
                    rect.Left, rect.Top, rect.Width, rect.Height, 92, 90);
            }

            //path.AddLine(new Point(rect.Left, rect.Top),
            //             new Point(rect.Right, rect.Top));

            //if (arcRadius > 0)
            //{
            path.AddArc(rect.Right, rect.Top,
                rect.Width, rect.Height, -90, 90);
            //}

            //path.AddLine(new Point(rect.Right, rect.Top),
            //new Point(rect.Right, rect.Bottom));

            //if (arcRadius > 0)
            //{
            path.AddArc(rect.Right, rect.Bottom,
                 rect.Width, rect.Height, 0, 90);
            //}

            //path.AddLine(new Point(rect.Right, rect.Bottom),
            ...
            //path.AddLine(new Point(rect.Left, rect.Bottom),
