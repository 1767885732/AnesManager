...
namespace Wis.Anes.Custom.CustomProject.CustomSetting
{
    public class CustomSetting : ICustomSetting
    {
        ...
        public void InitCustomSetting()
        {
            ...
            // 获取上传PDF配置
            //PostPDF_ServerURL = ConfigurationManager.AppSettings["PDF_ServerUrl"];
            //PostPDF_LocalURL = ConfigurationManager.AppSettings["PDF_LocalUrl"];
              PostPDF_ServerURL=  ApplicationConfiguration.PDFServerUrl ;
              PostPDF_LocalURL =  ApplicationConfiguration.PDFLocalUrl ;
            //PostPDF_Names = ConfigurationManager.AppSettings["PDF_PostDoc"].Split(',');
            // 获取上传PDF配置
            ...
            //监测项目默认持续配置
            MedSheetContinue = System.Configuration.ConfigurationSettings.AppSettings["MedSheetContinue"];
        }
    }
}
